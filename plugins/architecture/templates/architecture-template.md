...
> 사용하는 기술에 따라 해당 베스트 프랙티스 참조 (workflow 플러그인 설치 시 사용 가능)

- `best-practices/database.md` (architecture 플러그인)
- `best-practices/api-design.md` (architecture 플러그인)
- `best-practices/react.md` (workflow 플러그인)
- `best-practices/nodejs.md` (workflow 플러그인)
- `best-practices/typescript.md` (workflow 플러그인)
...
→ `templates/api-spec-template.md` 참조
