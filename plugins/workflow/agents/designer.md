...
# 3. 기존 UX 문서 확인
ls .workflow/artifacts/{앱명}/{기능명}/ux-scenario.md 2>/dev/null
```
...
### 5단계: UX 시나리오 문서 작성
UX 설계 결과를 `.workflow/artifacts/{앱명}/{기능명}/ux-scenario.md`에 작성:
...
```bash
bd update <issue-id> --description "디자인 완료. 화면 N개, 컴포넌트 N개. 상세: .workflow/artifacts/{앱명}/{기능명}/ux-scenario.md"
