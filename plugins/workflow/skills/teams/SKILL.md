...
| Work Sub-task | teams 스킬 | 4단계 시작 시 (captain이 결과 기록) |
...
captain 완료 후 요약을 텍스트로 표시한 후 AskUserQuestion 도구로 사용자 승인을 요청합니다.
...
options:
  ...
  - label: "수정 필요", description: "captain을 재호출하여 수정합니다"
  - label: "취소", description: "작업을 중단합니다"
multiSelect: false
```
