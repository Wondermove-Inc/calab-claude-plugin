...
# 1. 사전 요구사항 확인
echo -e "${CYAN}[1/5]${RESET} 사전 요구사항 확인..."
...
# 2. 디렉토리 생성
echo -e "${CYAN}[2/5]${RESET} 디렉토리 생성..."
mkdir -p ~/.claude
echo -e "${GREEN}  ✓ ~/.claude 디렉토리 준비됨${RESET}"

# 3. Statusline 스크립트 생성
echo -e "${CYAN}[3/5]${RESET} Statusline 스크립트 생성..."
...
echo -e "${CYAN}[4/5]${RESET} settings.json 업데이트..."
